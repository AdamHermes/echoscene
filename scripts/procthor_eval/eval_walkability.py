...
if __name__ == "__main__":
    ...
    scene_files = [os.path.join(scenes_dir, f) for f in os.listdir(scenes_dir) if f.endswith('.json') and not f.startswith('._') and not f.startswith('walkability_') and not f.startswith('navigation_')]
