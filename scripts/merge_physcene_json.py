"""
Merge multiple physcene_collision_input.json files (each produced by a separate
eval_3dfront.py run covering a different slice of samples) into a single combined file.
...
Usage:
    python merge_physcene_json.py out_merged.json in1.json in2.json in3.json ...

Or edit INPUT_FILES below and run with no args.
"""
import json
import sys
