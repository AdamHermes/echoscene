...
def main():
    ...
    out_scene_dir = os.path.join(out_base_dir, "echoscene")
    out_img_dir = os.path.join(out_base_dir, "render_imgs/echoscene")

    os.makedirs(out_base_dir, exist_ok=True)
    os.makedirs(out_mesh_dir_base, exist_ok=True)
    os.makedirs(out_mesh_shifted_dir_base, exist_ok=True)
    ...
    print(f"Saving copied JSON to {out_json}")
    ...
    for i in range(num_scenes):
        ...
        mesh_dir = os.path.join(out_mesh_dir_base, scene_id)
        mesh_dir_shifted = os.path.join(out_mesh_shifted_dir_base, scene_id)
        ...
        for j in range(len(cats)):
            ...
            obj.export(os.path.join(mesh_dir, os.path.basename(filepath)))
